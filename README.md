...
GitHub는 다음 세 가지 목적으로 운영될 예정입니다. 공지 식으로 변경. 최신 매뉴얼 링크 . 

**1. 데이터 표준화 및 품질관리 가이드라인 및 매뉴얼 documents 아카이브** 주요 다큐먼트는 앞에 따라 갈 수 있는 링크가 만들어질 수 있도로 ㄱ

**2. 데이터 유형별(예. 유전체, 단백체, 이미징, 기타 등) csv 파일 형식의 코딩북 제공** 유전체, 단백체, 기타 파일 링크 모두 넣기
